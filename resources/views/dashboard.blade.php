<x-layouts.dashboard>
    <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="card w-96 bg-gradient-to-br from-emerald-500 to-lime-600 shadow-xl rounded-xl text-white">
            <div class="card-body flex flex-col items-center justify-center p-8">
                <div class="mb-4">
                    <svg class="w-12 h-12 text-white opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
        ...
        <div class="card w-96 bg-gradient-to-br from-red-500 to-amber-600 shadow-xl rounded-xl text-white">
            <div class="card-body flex flex-col items-center justify-center p-8">
                <div class="mb-4">
                    <svg class="w-12 h-12 text-white opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                ...
                <span class="text-lg font-semibold tracking-wide">Low stock items</span>
                <span class="text-4xl font-bold mt-2">{{ $totalLowStockItems }}</span>
            </div>
        </div>
    </div>
</x-layouts.dashboard>
